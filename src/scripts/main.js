...
header.addEventListener('click', (mouseEvent) => {
  if (mouseEvent.target.classList.contains('full-name')) {
  ...
  if (mouseEvent.target.classList.contains('position')) {
  ...
  if (mouseEvent.target.classList.contains('age')) {
  ...
  if (mouseEvent.target.classList.contains('salary')) {
